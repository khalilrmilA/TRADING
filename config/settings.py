...
class Settings(BaseSettings):
    ...
    # Cap the context window per request. Without this, Ollama sizes the KV
    # cache for the model's full context (131k for llama3.2 → ~16 GB RAM) and
    # refuses to load on smaller machines. Platform prompts are only a few KB.
